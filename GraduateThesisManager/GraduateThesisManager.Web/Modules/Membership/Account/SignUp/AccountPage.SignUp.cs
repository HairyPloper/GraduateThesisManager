...
namespace GraduateThesisManager.Membership.Pages
{
    ...
    public partial class AccountController : Controller
    {
        ...
        {
            return this.UseConnection("GraduateThesisManager", connection =>
            {
        ...
        {
            using (var connection = SqlConnections.NewByKey("GraduateThesisManager"))
            using (var uow = new UnitOfWork(connection))
            {
                int userId;
                try
