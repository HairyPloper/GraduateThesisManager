...
(function (GraduateThesisManager) {
    ...
    })(BasicSamples = GraduateThesisManager.BasicSamples || (GraduateThesisManager.BasicSamples = {}));
})(GraduateThesisManager || (GraduateThesisManager = {}));
var GraduateThesisManager;
(function (GraduateThesisManager) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = GraduateThesisManager.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = GraduateThesisManager.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = GraduateThesisManager.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (GraduateThesisManager) {
    ...
    })(Northwind = GraduateThesisManager.Northwind || (GraduateThesisManager.Northwind = {}));
})(GraduateThesisManager || (GraduateThesisManager = {}));
var GraduateThesisManager;
(function (GraduateThesisManager) {
    var Northwind;
...
(function (GraduateThesisManager) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'GraduateThesisManager.Northwind.Gender', 'GraduateThesisManager.Northwind.Entities.Gender');
    })(Northwind = GraduateThesisManager.Northwind || (GraduateThesisManager.Northwind = {}));
})(GraduateThesisManager || (GraduateThesisManager = {}));
var GraduateThesisManager;
(function (GraduateThesisManager) {
...
(function (GraduateThesisManager) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(OrderShippingState, 'GraduateThesisManager.Northwind.OrderShippingState', 'Northwind.OrderShippingState');
    })(Northwind = GraduateThesisManager.Northwind || (GraduateThesisManager.Northwind = {}));
})(GraduateThesisManager || (GraduateThesisManager = {}));
var GraduateThesisManager;
(function (GraduateThesisManager) {
...
(function (GraduateThesisManager) {
    ...
    (function (BasicSamples) {
        ...
        }(GraduateThesisManager.Northwind.ProductDialog));
...
(function (GraduateThesisManager) {
    ...
    (function (BasicSamples) {
        ...
        }(GraduateThesisManager.Northwind.ProductGrid));
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        GraduateThesisManager.Common.ReportHelper.execute({
...
(function (GraduateThesisManager) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: GraduateThesisManager.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: GraduateThesisManager.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new GraduateThesisManager.Northwind.OrderDialog();
                        ...
                        var chai = GraduateThesisManager.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = GraduateThesisManager.Northwind.EmployeeRow.getLookup().items
        ...
        }(GraduateThesisManager.Northwind.OrderGrid));
...
(function (GraduateThesisManager) {
    ...
    (function (BasicSamples) {
        ...
        }(GraduateThesisManager.Northwind.OrderDialog));
...
(function (GraduateThesisManager) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    GraduateThesisManager.Northwind.CategoryService.Retrieve({
        ...
        }(GraduateThesisManager.Northwind.CategoryDialog));
...
(function (GraduateThesisManager) {
    ...
    (function (BasicSamples) {
        ...
        }(GraduateThesisManager.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(GraduateThesisManager.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new GraduateThesisManager.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                GraduateThesisManager.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(GraduateThesisManager.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    GraduateThesisManager.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(GraduateThesisManager.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(GraduateThesisManager.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    GraduateThesisManager.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return GraduateThesisManager.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return GraduateThesisManager.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return GraduateThesisManager.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return GraduateThesisManager.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var SupplierDialog = /** @class */ (function (_super) {
            ...
            SupplierDialog.prototype.getLanguages = function () {
                return GraduateThesisManager.LanguageList.getValue();
            };
...
(function (GraduateThesisManager) {
    ...
    (function (BasicSamples) {
        ...
        }(GraduateThesisManager.Northwind.SupplierDialog));
...
(function (GraduateThesisManager) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(GraduateThesisManager.Northwind.SupplierGrid));
...
(function (GraduateThesisManager) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return GraduateThesisManager.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return GraduateThesisManager.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return GraduateThesisManager.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return GraduateThesisManager.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return GraduateThesisManager.Northwind.OrderService.baseUrl; };
...
(function (GraduateThesisManager) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    GraduateThesisManager.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(GraduateThesisManager.Northwind.CustomerDialog));
...
(function (GraduateThesisManager) {
    ...
    (function (BasicSamples) {
        ...
        }(GraduateThesisManager.Northwind.CustomerGrid));
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = GraduateThesisManager.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return GraduateThesisManager.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return GraduateThesisManager.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new GraduateThesisManager.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(GraduateThesisManager.Northwind.OrderDetailDialog));
...
(function (GraduateThesisManager) {
    ...
    (function (BasicSamples) {
        ...
        }(GraduateThesisManager.Northwind.OrderDetailsEditor));
...
(function (GraduateThesisManager) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return GraduateThesisManager.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return GraduateThesisManager.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return GraduateThesisManager.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return GraduateThesisManager.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return GraduateThesisManager.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (GraduateThesisManager) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return GraduateThesisManager.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return GraduateThesisManager.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return GraduateThesisManager.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return GraduateThesisManager.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(GraduateThesisManager.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new GraduateThesisManager.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new GraduateThesisManager.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new GraduateThesisManager.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (GraduateThesisManager) {
    ...
    GraduateThesisManager.SelectableEntityGrid = SelectableEntityGrid;
})(GraduateThesisManager || (GraduateThesisManager = {}));
...
(function (GraduateThesisManager) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return GraduateThesisManager.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return GraduateThesisManager.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return GraduateThesisManager.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return GraduateThesisManager.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(GraduateThesisManager.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = GraduateThesisManager.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            GraduateThesisManager.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (GraduateThesisManager) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return GraduateThesisManager.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return GraduateThesisManager.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return GraduateThesisManager.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return GraduateThesisManager.Northwind.ProductService.baseUrl; };
...
(function (GraduateThesisManager) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return GraduateThesisManager.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return GraduateThesisManager.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return GraduateThesisManager.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return GraduateThesisManager.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (GraduateThesisManager) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return GraduateThesisManager.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return GraduateThesisManager.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (GraduateThesisManager) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return GraduateThesisManager.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return GraduateThesisManager.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return GraduateThesisManager.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
(function (GraduateThesisManager) {
    ...
    GraduateThesisManager.StaticTextBlock = StaticTextBlock;
})(GraduateThesisManager || (GraduateThesisManager = {}));
var GraduateThesisManager;
(function (GraduateThesisManager) {
    var Common;
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: GraduateThesisManager.Authorization.userDefinition.DisplayName,
